            ...
            <div className="flex items-center gap-1.5">
                  ...
                  {(allCodesSetSize ?? 0) > 0 && (
                    <>
                      ...
                      <span className="text-[9px] text-muted-foreground tabular-nums">
                        {(
                          (postalCodes.length / (allCodesSetSize ?? 1)) *
                          100
                        ).toFixed(1)}
                        %
                      </span>
              ...
              <div
                className={cn(
                  ...
                  !hoverActionsReady && "opacity-0 pointer-events-none",
                  hoverActionsReady && "opacity-0 group-hover:opacity-100"
                )}
              >
                {onSoloLayer && (
                  <button
                ...
                <DropdownMenu>
                  ...
                  >
                    ...
                    {onCompareLayer && postalCodes.length > 0 && (
                      <DropdownMenuItem
                        onClick={() => onCompareLayer(layer.id)}
                      >
